    ...
    return (
        <ListItem sx={{ borderBottom: `1px solid ${Colors.gray}`, padding: '10px 0' }}>
            <Grid container spacing={1} alignItems='center'>
                <Grid item xs={2} md={2} lg={2}><img src={imgPath} alt={title} height='60px' width='60px' /></Grid>
                <Grid item xs={6} md={6} lg={6}><Typography variant='basketText'>{title}</Typography></Grid> 
                <Grid item xs={3} md={3} lg={3}><MuiButton variant='counter' onClick={() => dispatch(cartActions.removeItemFromCart({ id }))}>-</MuiButton>
